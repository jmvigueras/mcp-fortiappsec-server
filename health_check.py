#!/usr/bin/env python3
"""
Health check script for FortiAppSec MCP Server
...
def health_check():
    ...
    print("🏥 FortiAppSec MCP Server Health Check")
    print("=" * 40)
    ...
    try:
        ...
        print("   ✅ Ready for FortiAppSec operations")

        print("\n5️⃣  Available Tools:")
        tools = [
            "📋 waf_list_applications - List all WAF applications",
            "🔍 waf_get_application - Get details of a WAF application",
            "➕ waf_create_application - Create a new WAF application",
            "🗑️  waf_delete_application - Delete a WAF application",
        ...
        print("   🛠️  Total Tools: 5 FortiAppSec management tools")

        print("\n✅ FortiAppSec MCP Server is healthy and operational!")
        return True
